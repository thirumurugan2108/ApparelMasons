...
export class TrendComponent implements OnInit {
  ...
  //statelist() {
  //  this.afs.collection('COVIDtable').valueChanges().subscribe(
  //    data => {
  ...
  //}
  getRealatedPost() {
    this.afs.doc('covidpost/relatedpost1').valueChanges().pipe(take(1)).subscribe(
      data => {
        this.relapost = data;
        console.log(data);
      }
    ...
    this.afs.doc('covidpost/relatedpost2').valueChanges().pipe(take(1)).subscribe(
      data => {
        this.relapost1 = data;
        console.log(data);
      }
    );
    this.afs.doc('covidpost/relatedpost3').valueChanges().pipe(take(1)).subscribe(
      data => {
        this.relapost2 = data;
        console.log(data);
      }
